        ...
        return (
            <div class='content-container'>
                ...
                <p class='section-text' style={{'margin-top':'20px', 'textAlign':'center'}}>
                    <strong>Latest:</strong> Article on using <code style={{'fontSize':'15px'}}> pylustrator</code> published in <a style={{'textDecoration':'none'}} href='https://towardsdatascience.com/generate-easily-reproducible-scientific-figures-with-pylustrator-9426292e07a4' target='_blank' rel='noreferrer noopener'>Towards Data Science</a>
                </p>
